...
public:
  ...
  FunctionMetadata(int protocol_version, const VersionNumber& cassandra_version,
...
public:
  ...
  AggregateMetadata(int protocol_version, const VersionNumber& cassandra_version,
                    const std::string& name, const Value* signature,
                    KeyspaceMetadata* keyspace,
                    const RefBuffer::Ptr& buffer, const Row* row);
...
public:
  ...
  ColumnMetadata(int protocol_version, const VersionNumber& cassandra_version,
...
public:
  ...
  void clear_columns();
  void build_keys_and_sort(int protocol_version, const VersionNumber& cassandra_version);
